...
const NAV = [
  ...
  { group: 'Platform', items: [
    ...
    { path: '/platform-integrations', label: 'Universal Integrations', icon: 'plug', platformOnly: true },
  ...
  { group: 'Administration', items: [
    ...
    { path: '/integrations', label: 'Integrations', icon: 'plug', tenantOnly: true , feature: 'universal-integrations' },
...
const routes = {
  ...
  '/platform-integrations': () => import('./pages/platform-integrations.js'),
