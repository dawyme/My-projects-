...
export async function render(view) {
  ...
  try { const r = await fetch('../api/health'); qs('#health',view).innerHTML = r.ok ? '<div class="alert alert--success">API is healthy and responding.</div>' : '<div class="alert alert--danger">API health check failed.</div>'; } catch { qs('#health',view).innerHTML = '<div class="alert alert--danger">API health check failed.</div>'; }
}
