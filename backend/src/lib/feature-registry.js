...
const TENANT_FEATURE_REGISTRY = [
  ...
  { key: 'supplier-marketplace', name: 'Marketplace Dashboard', description: 'Supplier marketplace dashboard', category: 'Supplier Marketplace', defaultEnabled: false, routes: ['/supplier-marketplace'], apiPrefixes: [] },
  { key: 'suppliers', name: 'Suppliers', description: 'Supplier management', category: 'Supplier Marketplace', defaultEnabled: false, routes: ['/suppliers'], apiPrefixes: ['/api/suppliers'] },
  { key: 'supplier-integrations', name: 'Integrations / Plugins', description: 'Supplier integrations and plugins', category: 'Supplier Marketplace', defaultEnabled: false, routes: ['/supplier-integrations'], apiPrefixes: ['/api/supplier-integrations'] },
  { key: 'supplier-imports', name: 'Import Products', description: 'Supplier product imports', category: 'Supplier Marketplace', defaultEnabled: false, routes: ['/supplier-imports'], apiPrefixes: ['/api/supplier-imports'] },
  { key: 'supplier-products', name: 'Supplier Products', description: 'Supplier product catalogue', category: 'Supplier Marketplace', defaultEnabled: false, routes: ['/supplier-products'], apiPrefixes: ['/api/supplier-products'] },
  { key: 'supplier-fulfillment', name: 'Fulfillment', description: 'Supplier fulfillment workflows', category: 'Supplier Marketplace', defaultEnabled: false, routes: ['/supplier-fulfillment'], apiPrefixes: ['/api/supplier-fulfillments'] },
  { key: 'supplier-shipping', name: 'Shipping', description: 'Supplier shipping management', category: 'Supplier Marketplace', defaultEnabled: false, routes: ['/supplier-shipping'], apiPrefixes: ['/api/supplier-shipping'] },
  { key: 'supplier-sync', name: 'Sync & Automation', description: 'Supplier synchronization and automation', category: 'Supplier Marketplace', defaultEnabled: false, routes: ['/supplier-sync'], apiPrefixes: ['/api/supplier-syncs'] },
  { key: 'supplier-logs', name: 'Sync Logs', description: 'Supplier synchronization logs', category: 'Supplier Marketplace', defaultEnabled: false, routes: ['/supplier-logs'], apiPrefixes: [] },
  { key: 'supplier-settings', name: 'Marketplace Settings', description: 'Supplier marketplace settings', category: 'Supplier Marketplace', defaultEnabled: false, routes: ['/supplier-settings'], apiPrefixes: ['/api/supplier-settings'] },
  { key: 'content-manager', name: 'Content Manager', description: 'Tenant website content management', category: 'Website', defaultEnabled: false, routes: ['/content'], apiPrefixes: ['/api/content', '/api/site-content'] },
  { key: 'media-library', name: 'Media Library', description: 'Tenant media asset library', category: 'Website', defaultEnabled: false, routes: ['/media'], apiPrefixes: ['/api/media'] },
