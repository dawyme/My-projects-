...
const { featureProtectedRoute } = require('./lib/features');
...
app.use('/api/dashboard', ...featureProtectedRoute('dashboard'), require('./routes/dashboard'));
app.use('/api/products', ...featureProtectedRoute('products'), require('./routes/products'));
...
app.use('/api/content', ...featureProtectedRoute('content-manager'), require('./routes/content'));
app.use('/api/site-content', ...featureProtectedRoute('content-manager'), require('./routes/site-content'));
app.use('/api/media', ...featureProtectedRoute('media-library'), require('./routes/media'));
app.use('/api/technicians', ...featureProtectedRoute('technicians'), require('./routes/technicians'));
app.use('/api/equipment', ...featureProtectedRoute('equipment'), require('./routes/equipment'));
app.use('/api/estimates', ...featureProtectedRoute('estimates'), require('./routes/estimates'));
app.use('/api/invoices', ...featureProtectedRoute('invoices'), require('./routes/invoices'));
app.use('/api/dispatch', ...featureProtectedRoute('dispatch'), require('./routes/dispatch'));
app.use('/api/reminders', ...featureProtectedRoute('notifications'), require('./routes/reminders'));
app.use('/api/service-history', ...featureProtectedRoute('service-history'), require('./routes/service-history'));
app.use('/api/service-requests', ...featureProtectedRoute('service-requests'), require('./routes/service-requests'));
app.use('/api/work-orders', ...featureProtectedRoute('work-orders'), require('./routes/work-orders'));
app.use('/api/recurring-maintenance', ...featureProtectedRoute('recurring-maintenance'), require('./routes/recurring-maintenance').router);

// ---- Supplier Marketplace (dedicated admin section) ----
app.use('/api/suppliers', ...featureProtectedRoute('suppliers'), require('./routes/suppliers'));
app.use('/api/supplier-integrations', ...featureProtectedRoute('supplier-integrations'), require('./routes/supplier-integrations'));
app.use('/api/supplier-products', ...featureProtectedRoute('supplier-products'), require('./routes/supplier-products'));
app.use('/api/supplier-imports', ...featureProtectedRoute('supplier-imports'), require('./routes/supplier-imports'));
app.use('/api/supplier-syncs', ...featureProtectedRoute('supplier-sync'), require('./routes/supplier-syncs'));
app.use('/api/supplier-fulfillments', ...featureProtectedRoute('supplier-fulfillment'), require('./routes/supplier-fulfillments'));
app.use('/api/supplier-shipping', ...featureProtectedRoute('supplier-shipping'), require('./routes/supplier-shipping'));
app.use('/api/supplier-settings', ...featureProtectedRoute('supplier-settings'), require('./routes/supplier-settings'));
